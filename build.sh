...
gcc -m32 -I./include -ffreestanding -fno-stack-protector -fno-pic -fno-pie -c kernel/scheduler.c -o kernel/scheduler.o
...
# Link
ld -m elf_i386 -nostdlib -T link.ld -o bin/kernel.bin boot/boot.o interrupts/interrupts.o kernel/kernel.o drivers/print.o drivers/keyboard.o kernel/mm.o kernel/string.o kernel/timer.o kernel/scheduler.o shell/shell.o interrupts/idt.o interrupts/pic.o
