...
# Link
ld -m elf_i386 -nostdlib -T link.ld -o bin/kernel.bin boot/boot.o interrupts/interrupts.o kernel/kernel.o drivers/print.o drivers/keyboard.o kernel/mm.o kernel/string.o shell/shell.o interrupts/idt.o interrupts/pic.o
